...
async function main() {
  ...
  const plans = [
    ...
    { providerCode: "disney_plus", planName: "Standard roczny", pricePLN: 349.9, cycle: "yearly", screens: 2, uhd: false, ads: false },
    { providerCode: "disney_plus", planName: "Premium roczny", pricePLN: 599.9, cycle: "yearly", screens: 4, uhd: true, ads: false },
  ...
  if (netflixPlan) {
    ...
    if (!existingNetflix) {
      ...
      console.log("Netflix subscription already exists");
    }
  }
